...
{
    private const string PrefabFolder = "Assets/_Game/Scenes/AreaSystem/Prefabs";
    private const string SampleFolder = "Assets/_Game/Scenes/AreaSystem/Prefabs/Samples";
