...
{
    private const string PlayerPrefabPath = "Assets/_Game/Features/Characters/Prefabs/Player_Base.prefab";
    private const string ZevPrefabPath = "Assets/_Game/Features/Characters/Prefabs/Enemy/ZEV_Prefab.prefab";
