...
{
    private const string TitleScenePath = "Assets/_Game/Content/Maps/Frontend/00_TitleScene.unity";
    private const string OverworldScenePath = "Assets/_Game/Content/Maps/Regions/PrologueSubway/Scenes/OverworldScene.unity";
