...
/// 다중 파티원과 다수 적군의 위치를 유연하게 관리하며, 카메라 트래킹을 위한 Transform을 제공합니다.
/// </summary>
public class PositionManager : MonoBehaviour
{
    ...
    // 🚨 카메라 트래킹(Cinemachine Follow)을 위한 Transform 원본 노출 프로퍼티
    public Transform CenterTransform => _centerPos;
    ...
    private Vector3 GetSafePosition(List<Transform> list, int index, string listName)
    {
        ...
        // 인덱스가 리스트 크기를 초과하면 가장 마지막 위치를 반환
