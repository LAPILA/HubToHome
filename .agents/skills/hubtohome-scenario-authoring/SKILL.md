...
- The default battle bridge currently registers only runtime-backed starter adapters: `flow.wait` and `dialogue.wait`. Dialogue IDs still need an authoring/import registration path before scenario-authored dialogue actions can run in content.
