...
- Existing `SkillData.ActionTimeline` execution is exposed through `battle.skill.timeline` and `ISkillTimelineRunner`. This is a compatibility adapter, not the owner of whole-battle scenario flow.
