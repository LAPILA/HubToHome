...
- `dialogues` entries whose `dialogueData` / `DialogueDataId` cannot resolve through `IScenarioDialogueReferenceResolver`; importer error code is `scenario.dialogue.unresolved`.
